              ...
              {data.length > 0 ? (
                data.map((note, index) => {
                  return (
                    <li
                      key={index}
                      className="p-2 shadow-md rounded-2xl bg-zinc-100 w-full "
                    >
                      <div className="flex items-end justify-between pb-3 border-b border-gray-300">
                        ...
                        >
                          ...
                          <button
                            type="button"
                            className="bg-red-400 font-semibold px-3 py-1 rounded-lg hover:bg-red-600 text-white cursor-pointer transition-colors ease-in-out duration-200"
                ...
                <div className="h-full w-full flex items-center justify-center">
                  <h2 className="bg-zinc-100 w-full rounded-lg p-3 shadow-lg text-center">
                    Nothing here...yet!
                  </h2>
                </div>
              )}
